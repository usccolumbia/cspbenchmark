...
class Fingerprint(object):
    ...
    """
    def __init__(self, unique_atom_types, atoms=None, Rc1=6.0, Rc2=4.0, binwidth1=0.2, Nbins2=30, sigma1=0.2, sigma2=0.2, eta=20, gamma=2, use_angular=True, nsigma=6):
        ...
        self.initialize_vectors(unique_atom_types)
    ...
    def initialize_vectors(self, unique_atom_types):
        # Prepare stuff to handle multiple species
        self.atomic_types = sorted(unique_atom_types)
        ...
        for i in range(Natoms):
            for cell_index in range(Ncells):
                ...
                for j in range(Natoms):
                    ...
                    normalization /= 4*M_PI*Rij*Rij * binwidth1 * num_pairs
