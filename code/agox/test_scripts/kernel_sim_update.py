...
from agox.samplers.kernel_similarity import KernelSimSampler

# sample_size = 10
# sampler = KMeansSampler(feature_calculator=model.get_feature_calculator(), 
#     database=database, sample_size=sample_size, order=1)

sampler = KernelSimSampler(feature_calculator=model.get_feature_calculator(),
...
agox = AGOX(collector, acquisitor, database, evaluator, seed=1)
