...
from agox.databases import Database, ConcurrentDatabase
...
database = ConcurrentDatabase(filename=db_path, order=6)
...
sample_size = 10
sampler = ParallelTemperingSampler(temperatures=[1], database=database, order=5.5)
...
agox = AGOX(collector, acquisitor, database, evaluator, sampler, seed=1)
